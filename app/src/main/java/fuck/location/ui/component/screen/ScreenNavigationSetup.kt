...
@Composable
fun ScreenNavigationSetup(navController: NavHostController, fragmentManager: FragmentManager) {
    NavHost(navController = navController, startDestination = ScreenNavItem.Main.route) {
        composable(ScreenNavItem.Main.route) {
            ...
            Scaffold(
                ...
                Column() {
                    MainNavigationSetup(navController = mainNavController, fragmentManager = fragmentManager)
                }
            }
        }
    }
